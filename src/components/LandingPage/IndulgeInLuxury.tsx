...
const IndulgeInLuxury = () => {
  return (
    <div className="mx-6 sm:px-16 flex mt-24  flex-col sm:flex-row sm:gap-12  items-start sm:items-center  justify-start">
        <div className="sm:flex sm:flex-col gap-6 justify-start ">
            ...
            <Link className='bg-primary w-64 mt-6 block text-secondary dark:border text-center py-2 px-6' to="/">
                SHOP NOW
            </Link>
        </div>
